export default {
	...
	hasPermssion: 0,
	credits: "Dũngkon",
	description: "Thư viện Ảnh nude",
	shortDescription: "Thư viện Ảnh nude",
	usages: [
		'nude: random ảnh nude'
	],
	cooldowns: 5
};
...
export async function run({ api, event, utils, UsersAll, client }) {
	try {
		...
		const path = ps.resolve(__dirname, 'cache', `nude.png`);
		const { data } = (await axios.get(`https://image-random-api.dungkon.repl.co/nude/?apikey=0bk3s6IAyq`))
